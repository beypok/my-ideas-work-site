...
export class init1680274791554 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`offering_files\` ADD CONSTRAINT  \`FK_531bb15cc3c53b256ba573ac05a\` FOREIGN KEY (\`offeringId\`) REFERENCES \`offerings\`(\`offeringId\`) ON DELETE NO ACTION ON UPDATE NO ACTION IF NOT EXISTS`);
